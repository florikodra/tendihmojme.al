    ...
    <div class="card" style="border-radius: 2rem">
        ...
        <div class="card-body">
              <div class="list-group">
                ...
                <a href="{{ route('posts') }}" class="list-group-item list-group-item-action rounded-pill {{ request()->routeIs('posts') ? 'active' : '' }}"><i class="fas fa-box"></i> Njoftimet e mia <span class="badge badge-primary float-right">{{ $nrPostimeve }}</span></a><br>
                @if($nrPostimeve)
                <a href="{{ route('posts-requests') }}" class="list-group-item list-group-item-action rounded-pill {{ request()->routeIs('posts-requests') ? 'active' : '' }}">Kerkesat per njoftimet</a><br>
                @endif
